...
////		System.out.print("测试数据修改"+"" +tem+" " + userTem);
////
...
////	// path是指欲下载的文件的路径。
////		File file = new File("D:\\？？？\\testRed.xls");
////		// 取得文件名。
////		String filename = file.getName();
////		// 以流的形式下载文件。
////		InputStream fis = new BufferedInputStream(new FileInputStream("D:\\？？？\\testRed.xls"));
...
//	}
//	@RequestMapping("/putInExcel")
//	public void putInExcel(HttpServletRequest request,HttpServletResponse response) throws Exception {
//
//	}
//
//}
